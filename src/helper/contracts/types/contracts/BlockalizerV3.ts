...
export interface BlockalizerV3Interface extends utils.Interface {
  functions: {
    ...
    "incrementTokenId()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "incrementTokenId",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BlockalizerV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlockalizerV3Interface;
  ...
  callStatic: {
    ...
    incrementTokenId(overrides?: CallOverrides): Promise<void>;
