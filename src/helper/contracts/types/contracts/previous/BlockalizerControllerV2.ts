...
export interface BlockalizerControllerV2Interface extends utils.Interface {
  functions: {
...
export interface BlockalizerControllerV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlockalizerControllerV2Interface;
